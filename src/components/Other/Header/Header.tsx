      ...
      <div className="container mx-auto">
        <div className="md:grid md:grid-cols-3 items-center flex justify-between">
          <div className="flex flex-row">
            <h2 className="text-white text-2xl font-bold font-abril">Victor Ciolac</h2>
          </div>

          <div className="hidden xl:block">
            <Nav
              containerStyles="flex gap-x-6 items-center justify-center"
              linkStyles="relative hover:text-primary transition-all text-white text-xl font-abril"
